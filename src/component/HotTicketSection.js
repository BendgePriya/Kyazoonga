        ...
        <section className="hot-ticket-sec ticket-boxes">
          <div className="container">
                        ...
                        return(
                          ...
                          <div className="box">
                            <a href="#" className="block-link">
                              <div className="ticket-img">
                                <img src="http://54.149.90.101/EventBuilder/Images/sport/ht-isl-jfc.gif" alt />
                                <span className="ticket-price">{obj.price}</span>
                              </div>
                              <div className="ticket-info">
                                <span className="time-info">{obj.time}</span>
                                <h3 className="ticket-title">{obj.season}</h3>
                                <p className="venue-info">{obj.area}</p>
                              </div>
                            </a>
                            <div className="social clearfix">
                              <div className="pull-left">
            ...
            <div className="btn-sec text-center p-20 pt-0">
              <a href="#" className="btn btn-primary btn-custome-lg" style={{color:'#337ab7'}}>Discover More</a>
            </div>
          </div>
        </section>
      )
